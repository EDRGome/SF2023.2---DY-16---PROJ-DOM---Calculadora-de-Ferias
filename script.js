function main() {
  const INsalarioBruto = parseFloat(
    document.querySelector("#INPUTsalarioBruto").value
  );
  const INmesesTrabalhados = parseFloat(
    document.querySelector("#INPUTmesesTrabalhados").value
  );
  ...
  function feedback() {
    ...
    if (INmesesTrabalhados < 12) {
      OUTfeedback.innerHTML =
        "Seu tempo de serviço ainda é insuficiente para tirar férias";
      ...
      OUTfeedback.innerHTML =
        "Não é permitido acumular férias, tire suas férias.";
    }
  }
  ...
  function calcularFeriasProporcionais() {
    const OUTvalorFeriasProporcionais = document.querySelector(
      "#OUTPUTvalorFeriasProporcionais"
    );
    const OUTvalorUmTercoFerias = document.querySelector(
      "#OUTPUTvalorUmTercoFerias"
    );

    valorFeriasProporcionais = (INsalarioBruto * INmesesTrabalhados) / 12;
    valorUmTercoFerias = valorFeriasProporcionais / 3;

    OUTvalorFeriasProporcionais.innerHTML = `R$${valorFeriasProporcionais.toFixed(
      2
    )}`;
  ...
  function calcularTotalFeriasProporcionais() {
    const OUTvalorTotalFeriasProporcionais = document.querySelector(
      "#OUTPUTvalorTotalFeriasProporcionais"
    );
    valorTotalFeriasProporcionais =
      valorFeriasProporcionais + valorUmTercoFerias - valorDesconto;
    OUTvalorTotalFeriasProporcionais.innerHTML = `R$${valorTotalFeriasProporcionais.toFixed(
      2
    )}`;
  }
}
